...
recall_values = cross_val_score(classifier_new, X_test, y_test, scoring='recall_weighted', cv=num_folds)
print(f"Recall: {round(100 * recall_values.mean(), 2)}%")
f1_values = cross_val_score(classifier_new, X_test, y_test, scoring='f1_weighted', cv=num_folds)
